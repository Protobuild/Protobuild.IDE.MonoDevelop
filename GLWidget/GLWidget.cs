...
namespace Gtk
{
    ...
    public class GLWidget : DrawingArea, IDisposable
    {
        ...
        private bool poisonedWindowHandle;

        private bool reconstructWindowHandlesOnBrokenX;

        public void PoisonWindowHandle()
        {
            poisonedWindowHandle = true;
        }
        ...
        private delegate IntPtr XErrorHandlerCallback(IntPtr display, IntPtr @event);

        [DllImport("libX11", EntryPoint = "XSetErrorHandler")]
        static extern IntPtr XSetErrorHandler(XErrorHandlerCallback fn);
